<h1 align="center">SSH Ramdisk Script (Test repo)</h1>
<p align="center">
...
3. Compile https://github.com/haiyuidesu/iBoot64Patcher and replace in Darwin

# Usage

1. Clone and cd into this repository: `git clone https://github.com/frankpanduh/SSHRD_Script_test --recursive && cd SSHRD_Script_test`
    - If you have cloned this before, run `cd SSHRD_Script_test && git pull` to pull new changes
